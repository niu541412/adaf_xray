...
{
   XSModelFunction* funcObj = new XSCall<xsf77Call>(badaf_);
...
//adaf_xray
void f_adafp(const float* energy, int nFlux, const float* params,
             int spectrumNumber, float* flux, float* fluxError);

FCALLSCSUB6(f_adafp,ADAFP,adafp,FLOATV,INT,FLOATV,INT,FLOATV,FLOATV)
FCALLSCSUB7(C_adafp,DADAFP,dadafp,DOUBLEV,INT,DOUBLEV,INT,DOUBLEV,DOUBLEV,STRING)
